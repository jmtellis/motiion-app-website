...
export const ANALYTICS_EVENTS: Record<string, AnalyticsEventDefinition> = {
  ...
  industry_onboarding_started: {
    name: "industry_onboarding_started",
    label: "Industry onboarding started",
    category: "onboarding",
    description: "Industry professional started workspace onboarding",
  },
  industry_onboarding_step_viewed: {
    name: "industry_onboarding_step_viewed",
    label: "Industry onboarding step viewed",
    category: "onboarding",
    description: "Industry onboarding step displayed",
  },
  industry_onboarding_step_completed: {
    name: "industry_onboarding_step_completed",
    label: "Industry onboarding step completed",
    category: "onboarding",
    description: "Industry onboarding step completed successfully",
  },
  industry_onboarding_back_clicked: {
    name: "industry_onboarding_back_clicked",
    label: "Industry onboarding back clicked",
    category: "onboarding",
    description: "User navigated back in industry onboarding",
  },
  industry_onboarding_abandoned: {
    name: "industry_onboarding_abandoned",
    label: "Industry onboarding abandoned",
    category: "onboarding",
    description: "User canceled industry onboarding",
  },
  industry_onboarding_completed: {
    name: "industry_onboarding_completed",
    label: "Industry onboarding completed",
    category: "onboarding",
    description: "Industry professional finished workspace onboarding",
  },
  industry_onboarding_primary_action_clicked: {
    name: "industry_onboarding_primary_action_clicked",
    label: "Industry onboarding primary action clicked",
    category: "onboarding",
    description: "User clicked personalized post-onboarding CTA",
  },
  industry_verification_prompted: {
    name: "industry_verification_prompted",
    label: "Industry verification prompted",
    category: "onboarding",
    description: "Identity verification modal shown for a gated action",
  },
  industry_verification_started: {
    name: "industry_verification_started",
    label: "Industry verification started",
    category: "onboarding",
    description: "User started Stripe Identity verification",
  },
  industry_verification_completed: {
    name: "industry_verification_completed",
    label: "Industry verification completed",
    category: "onboarding",
    description: "User completed Stripe Identity verification",
  },
  shortlist_viewed: {
